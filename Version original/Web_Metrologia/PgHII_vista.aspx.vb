...
Public Class PgHII_vista
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            objcon.conectar()
            Dim consulta As String = "select distinct(IdeBpr) from Balxpro where est_esc='PL' and ClaBpr='II'"
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownList1.SelectedIndexChanged
        If DropDownList1.SelectedIndex > 0 Then
            ...
            Else
                ...
                Dim ObjCmd = New SqlCommand("select LitBpr from Balxpro where IdeBpr=" & DropDownList1.SelectedValue & " and ClaBpr='II' and est_esc='PL'", ccn)
                Dim adaptador As SqlDataAdapter = New SqlDataAdapter(ObjCmd)
                Dim ds As DataSet = New DataSet()
                adaptador.Fill(ds)
...
aqui:
            ...
            For i = 0 To dimension - 1
                ...
                'µ(dmp)
                tCell = New HtmlTableCell
                tCell.InnerText = coma(Val(coma(vector_u_deriva_patron(i))).ToString("E3"))
                tRow.Cells.Add(tCell)
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    Protected Sub btGenerar_Click(sender As Object, e As EventArgs) Handles btGenerar.Click
        ...
        Try
            ...
            Response.Redirect("PgHII_vista.aspx", False)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If TextBox1.Text = "" Then
            consulta = "select distinct(IdeBpr) from Balxpro where est_esc='PL' and ClaBpr='II'"
        Else
