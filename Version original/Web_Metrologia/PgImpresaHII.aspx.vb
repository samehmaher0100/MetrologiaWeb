...
aqui:
            ...
            For i = 0 To dimension - 1
                ...
                End If
                tCell = New HtmlTableCell
                    tCell.InnerText = coma(Oeff.ToString("E2"))
                    tRow.Cells.Add(tCell)
                    'k
            ...
            While (ObjReader1.Read())
                ...
                ObjReader2.Close()
                    ...
                    'lblIncertidumbreExct2.Text = coma(incert.ToString("0.000000000"))
                End While
            ObjReader1.Close()
            Dim i_2 As Integer
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    Protected Sub btGenerar_Click(sender As Object, e As EventArgs) Handles btGenerar.Click
        ...
        Try
            ...
            Response.Redirect("PgImpresaHII.aspx", False)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
