...
Public Class PgHcam_vista
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            objcon.conectar()
            Dim consulta As String = "select distinct(IdeBpr) from Balxpro where est_esc='PL' and ClaBpr='Camionera'"
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownList1.SelectedIndexChanged
        If DropDownList1.SelectedIndex > 0 Then
            ...
            Else
                ...
                Dim ObjCmd = New SqlCommand("select LitBpr from Balxpro where IdeBpr=" & DropDownList1.SelectedValue & " and ClaBpr='Camionera' and est_esc='PL'", ccn) '"", ccn)
                Dim adaptador As SqlDataAdapter = New SqlDataAdapter(ObjCmd)
                Dim ds As DataSet = New DataSet()
                adaptador.Fill(ds)
    ...
    Protected Sub ImageButton1_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton1.Click
        ...
        While (ObjReader.Read())
            ...
            'lblCarga_exct.Text = lblCarga_exct.Text & " " & unidad
            ...
            '"where CodBpr = " & codigoBpr & " and PrbCam_c = 1"
...
aqui:
            ...
            For i = 0 To dimension - 1
                ...
                Label5.Text = Label5.Text & "u(res)" & i & ": " & Val(coma(u_res_d)) ^ 2 & "||"
                'µ(rept)=
                tCell = New HtmlTableCell
                ...
                Label5.Text = Label5.Text & "u(rep)" & i & ": " & Val(coma(repetibilidad_total)) ^ 2 & "||"
                'µ(EXC)=
                tCell = New HtmlTableCell
                ...
                Label5.Text = Label5.Text & "u(EXC)" & i & ": " & Val(coma(exc)) ^ 2 & "||"
                'µ(Hist)=
                tCell = New HtmlTableCell
                ...
                Label5.Text = Label5.Text & "u(Hist)" & i & ": " & Val(coma(histe)) ^ 2 & "||"
                'µ(Res cero)
                tCell = New HtmlTableCell
                ...
                Label5.Text = Label5.Text & "u(Res cero)" & i & ": " & Val(coma(u_res_cero)) ^ 2 & "||"
                'separador
                tCell = New HtmlTableCell
                tCell.InnerText = " "
                tRow.Cells.Add(tCell)
            ...
            For i = 0 To dimension - 1
                ...
                'tRow.Cells.Add(tCell)
                'µ(I)
                Label6.Text = Label6.Text & "|| n°:(" & i & ") = " & cuadrado_indicacion(i)
                tCell = New HtmlTableCell
                ...
                If vector_nominal(i) <> 0 Then
                    ...
                    Else
                        ...
                        Dim umref_valcons As Double = Math.Sqrt(Val(cuadrado_patron(umref_const)))
                        Dim ui_valcons As Double = Math.Sqrt(Val(cuadrado_indicacion(umref_const)))
                        Dim esa As Double = Math.Sqrt(Val(cuadrado_indicacion(i - 1)))
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    Protected Sub btGenerar_Click(sender As Object, e As EventArgs) Handles btGenerar.Click
        ...
        Try
            ...
            Response.Redirect("PgHcam_vista.aspx", False)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If TextBox1.Text = "" Then
            consulta = "select distinct(IdeBpr) from Balxpro where est_esc='PL' and ClaBpr='Camionera'"
        Else
