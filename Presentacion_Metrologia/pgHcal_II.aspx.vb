...
Public Class pgHcal_II
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            objcon.conectar()
            Dim consulta As String = "select distinct(IdeBpr) from Balxpro where (est_esc='PR' or est_esc='CR') and ClaBpr='II'"
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownList1.SelectedIndexChanged
        If DropDownList1.SelectedIndex > 0 Then
            ...
            Else
                ...
                Dim ObjCmd = New SqlCommand("select LitBpr from Balxpro where IdeBpr=" & DropDownList1.SelectedValue & " and ClaBpr='II' and (est_esc='PR' or est_esc='CR')", ccn)
                Dim adaptador As SqlDataAdapter = New SqlDataAdapter(ObjCmd)
                Dim ds As DataSet = New DataSet()
                adaptador.Fill(ds)
...
aqui:
            ...
            For i = 0 To dimension - 1
                ...
                tCell.InnerText = coma(uexp.ToString("E1"))  'coma((uer(i) * k(i)).ToString("E1"))
                tRow.Cells.Add(tCell)
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    Protected Sub btGenerar_Click(sender As Object, e As EventArgs) Handles btGenerar.Click
        ...
        Try
            ...
            Response.Redirect("pgHcal_II.aspx", False)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
