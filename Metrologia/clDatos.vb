...
Public Class clDatos
    ...
    Dim sql As String
    Public Function inserta_cli(ByVal nom As String,
                           ByVal ci As String,
                           ByVal ciu As String,
                           ByVal dir As String,
                           ByVal ema As String,
                           ByVal tel As String,
                           ByVal con As String,
                           ByVal est As String, ByVal Actividad As String) As Boolean
        Dim ccn = objcon.ccn

        sql = "INSERT INTO CLIENTES (NomCli,CiRucCli,CiuCli,DirCli,EmaCli,TelCli,ConCli,EstCli,matProCli) " &
              "values ('" & nom & "','" & ci & "','" & ciu & "','" & dir & "','" & ema & "','" & tel & "','" & con & "','" & est & "','" & Actividad & "')"
        Try
            'ccn.Close()
            'ccn.Open()
            objcon.conectar()
    ...
    Public Function inserta_proyecto(ByVal estado As String, _
        ...
        sql = "insert into proyectos([EstPro]
           ,[FecPro]
           ,[FecSigCalPro]
           ,[CodCli]
           ,[Idepro]
           ,[CodMet]
           ,[LocPro]) values ('" & UCase(estado) & "'" &
                            ",GETDATE(),GETDATE()," &
