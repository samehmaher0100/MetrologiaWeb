...
Public Class Frm_ReportesClaseCamioenra
...
aqui:
            ...
            For i = 0 To dimension - 1
                ...
                tRow.Cells.Add(tCell)
                U_reporte(i) = uexp 'coma(uexp.ToString("0.000000")) 'coma((uer(i) * k(i)).ToString("0.000000")) 'coma((uer(i) * k(i)).ToString("E1"))
                'creo Row
            ...
            For i = 0 To dimension - 1
                ...
                'U exp
                tCell = New HtmlTableCell
                tCell.InnerText = Convert.ToDouble(U_reporte(i)).ToString("0.000")
                tRow.Cells.Add(tCell)
                'creo Row
