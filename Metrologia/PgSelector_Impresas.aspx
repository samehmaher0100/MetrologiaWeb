<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="PgSelector_Impresas.aspx.vb" Inherits="Metrologia.PgSelector_Impresas" %>
...
<script type="text/javascript">
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td style="width: 619px">Visor de Hojas de cálculo para Certificados que ya han sido impresos</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 323px">&nbsp;</td>
            <td style="width: 619px">
                <asp:Button ID="Button2" runat="server" Text="Cargar Hoja de cálculo" />
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
