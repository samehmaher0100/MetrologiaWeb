...
Public Class pgHcal_IIIyIIII
    ...
    Public Function Grados_de_Libertad(uer As String, Incertidumbre As String, ures As String, urescero As String, UEXC As String, UHist As String, Upat As String, UmB As String, udmp As String, udmcom As String) As Double
        ...
        Lbl_VGradosLibertad.Text += uer & "^ 4 / (" & Incertidumbre & "^ 4 / (3 - 1) +" & ures & " ^ 4 / 100 + " & urescero & " ^ 4 / 100 + " & UEXC & "^ 4 / 100 + " & UHist & " ^ 4 / 100 + " & Upat & "^ 4 / 100 +" & UmB & " ^ 4 / 100 + " & udmp & "^ 4 / 100 + " & udmcom & "^ 4 / 100); <br/>"
        Return respuesta
    End Function
    ...
    Public Function Valor_K(var_calculo As Double) As Double
        ...
        Try
            Lbl_VK.Text += "(1 - 0.95," & var_calculo & ") = " & MathNet.Numerics.ExcelFunctions.TInv(1 - 0.95, var_calculo) & " <br/>"
    ...
    Private Sub Imprimir()
        ...
        Dim host As String = Request.Url.ToString().Replace("pgHcal_IIIyIIII.aspx", "Reportes/Frm_ReporteClaseIII.aspx")
...
aqui:
                ...
                If (idecombpr.Length = 8) Then
                    str6 = "select max(abs(PCarga_Det.LecDscPca-PCarga_Det.LecAscPca))" &
                      "FROM PCarga_Cab INNER JOIN PCarga_Det ON dbo.PCarga_Cab.IdeComBpr  = substring(dbo.PCarga_Det.CodPca_C,1,8) " &
            ...
            For i = 0 To dimension - 1
                ...
                'tCell.InnerText = coma(Convert.ToDouble(v_Histe(i)).ToString("0.000000000"))
                'tRow.Cells.Add(tCell)
            ...
            For i = 0 To dimension - 1
                ...
                tCell = New HtmlTableCell
                'REVISION N11
                tCell.InnerText = (Grados_de_Libertad(uer(i), desviacion, v_Ures(i), v_Res0(i), v_Uexc(i), v_Histe(i), v_Vpat(i), v_mb(i), v_Smp(i), v_Smcom(i))).ToString().Replace("NaN", "0")
                tRow.Cells.Add(tCell)
                'k
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim Res As String = Formula.Formula(Request.QueryString("Proyecto") & Request.QueryString("Item"))
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    Protected Sub btGenerar_Click(sender As Object, e As EventArgs) Handles btGenerar.Click
        ...
        Try
            ...
            If Revision.Equals("Revision") Then
                ...
                objcon.conectar()
                'Dim Sql As String = "Insert into Observaciones values (" & lblcmdbpr.Text & ",'7.- " & txtObs7.Text & "')"
                Dim Sql As String = "update Balxpro set est_esc='PL', FechaRevision=getdate(),es_adi='Por_Liberar',Revisado_Por='" & lblUsuario.Text & "',CargoRevisado='" & lblCargo.Text & "'  where IdeComBpr='" & lblidecombpr.Text & "'"
                Dim ObjWriter = New SqlDataAdapter()
    ...
    Private Sub btGenerar_Load(sender As Object, e As EventArgs) Handles btGenerar.Load
