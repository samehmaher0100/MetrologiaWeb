<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="PgHIII.aspx.vb" Inherits="Metrologia.PgHIII" %>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td colspan="2" style="border: thin solid #008000; font-size: x-large; font-weight: bold; font-style: normal; color: #808000; vertical-align: middle; text-align: center;" rowspan="2">
                HOJA DE CÁLCULO PARA BALANZA CLASE III y IIII</td>
            <td style="border-left: thin solid #0000FF; border-right: thin none #0000FF; border-top: thin solid #0000FF; border-bottom: thin none #0000FF;font-size: x-large; font-weight: bold; font-style: normal; color: #808000; vertical-align: middle; text-align: center; " colspan="2" rowspan="4">
                REVISIÓN SATISFACTORIAS<img alt="impreso" src="images/impreso.jpg" style="width: 401px; height: 205px" /></td>
        </tr>
        <tr>
            <td style="border: thin solid #008000; width: 11%;">
        ...
        <tr>
            ...
            <td style="border: thin solid #008000; width: 1138px;">
...
&nbsp;</td>
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:TextBox ID="txtObs12" runat="server" Width="1508px" Visible="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
