...
Partial Class pgCliente
    ...
    Protected Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Try
            ...
            If Cbx_Actividad.Text = "Seleccionar..." Then

                Cbx_Actividad.Text = "OTROS 1"
            End If
            ...
            If btnGuardar.Text = "Guardar" Then
                ...
                Dim resultado As Boolean = objdat.inserta_cli(txtNombreCli.Text,
                                                      ...
                                                      txtEmailCli.Text,
                                                      txtTelefonoCli.Text,
                                                      txtContactoCli.Text, "A", Cbx_Actividad.SelectedValue)
            ...
            Else
                Dim Sqlstr As String = "update Clientes set NomCli='" & txtNombreCli.Text & "',CiRucCli='" & txtCiRucCli.Text & "', CiuCli='" & txtCiudadCli.Text & "', " &
                    "DirCli='" & txtDireccionCli.Text & "',EmaCli='" & txtEmailCli.Text & "',TelCli='" & txtTelefonoCli.Text & "',ConCli='" & txtContactoCli.Text & "',matProCli='" & Cbx_Actividad.SelectedValue & "' where CodCli=" & lblCodigoCli.Text & ""
                Dim ccn = objcon.ccn
                objcon.desconectar()
                objcon.conectar()
    ...
    Private Sub limpia_tod()
        ...
        txtContactoCli.Text = ""
        btnGuardar.Text = "Guardar"
        Cbx_Actividad.Text = "Seleccionar..."
