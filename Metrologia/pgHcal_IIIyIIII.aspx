<%@ Page Title="" Language="vb" AutoEventWireup="true" EnableEventValidation = "false" MasterPageFile="~/MasterPage.Master" CodeBehind="pgHcal_IIIyIIII.aspx.vb" Inherits="Metrologia.pgHcal_IIIyIIII" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  
<h3>  HOJA DE CÁLCULO PARA BALANZA CLASE III | Rev 11</h3>
    <br />
    ...
    <table class="table table-sm table-bordered ">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="PgEstadoProyectos.aspx">PgEstadoProyectos.aspx</a>
            </td>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:Label ID="Lbl_Errror" runat="server" Text=""></asp:Label>
   ...
   <br />
    ...
    <asp:Label ID="Lbl_VGradosLibertad" runat="server" Text=""></asp:Label>
    <asp:Label ID="Lbl_VK" runat="server" Text=""></asp:Label>
