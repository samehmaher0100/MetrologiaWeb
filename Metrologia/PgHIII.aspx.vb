...
Public Class PgHIII
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            objcon.conectar()
            Dim consulta As String = "select distinct(IdeBpr) from Balxpro where est_esc='PL' and (ClaBpr='III' or ClaBpr='IIII')"
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownList1.SelectedIndexChanged
        If DropDownList1.SelectedIndex > 0 Then
            ...
            Else
                ...
                Dim ObjCmd = New SqlCommand("select LitBpr from Balxpro where IdeBpr=" & DropDownList1.SelectedValue & " and (ClaBpr='III' or ClaBpr='IIII') and est_esc='PL'", ccn)
                Dim adaptador As SqlDataAdapter = New SqlDataAdapter(ObjCmd)
                Dim ds As DataSet = New DataSet()
                adaptador.Fill(ds)
    ...
    Protected Sub ImageButton1_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton1.Click
        ...
        While (ObjReader.Read())
            ...
            While (ObjReader1.Read())
                ...
                Dim incert As Double = Val(lblValExctMax.Text) / (2 * Val(lblValCarga_exct.Text) * Math.Sqrt(3))
            ...
            While (ObjReader_b_a.Read())
                Dim certif, tipo, n1, n2, n2a, n5, n10, n20, n20a, n50, n100, n200, n200a, n500, n1000,
                        n2000, n2000a, n5000, n10000, n20000, n500000, n1000000 As String 'AA
...
aqui:
                ...
                If Val(coma(histeresis)) <= Val(coma(maxhisteresis)) Then
            ...
            For i = 0 To dimension - 1
                ...
                Dim u_res As String = coma(Val((valor_d)) / Val((raizdetres_x2)))
                'Label5.Text = u_ress
                tCell.InnerText = u_res
                tRow.Cells.Add(tCell)
                ...
                'µ(EXC)=
                tCell = New HtmlTableCell
                Dim exc As Double = Val(excentricidad_total) * Val(vector_convencional(i))
                ...
                'Label5.Text = Label5.Text & "u(pat)" & i & ": " & Val(coma(vector_u_std_patron(i))) & "||"
                ...
                tCell.InnerText = coma(umb.ToString("E5")) ' coma(umb.ToString("E2"))
                tRow.Cells.Add(tCell)
                cuadrado_patron(i) = cuadrado_patron(i) + Val(coma(umb)) ^ 2
                'Label5.Text = Label5.Text & "u(mB)" & i & ": " & cuadrado_patron(i) & "||"
                'µ(dmp)
                tCell = New HtmlTableCell
                ...
                'Label5.Text = Label5.Text & "u(dmp)" & i & ": " & cuadrado_patron(i) & "||"
                'Δmconv
                tCell = New HtmlTableCell
                ...
                Label5.Text = Label5.Text & "u(dmconv)" & i & ": " & cuadrado_patron(i) & "||"
                'creo Row
            ...
            For i = 0 To dimension - 1
                ...
                'µ(I)
                tCell = New HtmlTableCell
                tCell.InnerText = coma((Math.Sqrt(cuadrado_indicacion(i))).ToString("0.000000000"))
                tRow.Cells.Add(tCell)
                ''µ(mref)
                'tCell = New HtmlTableCell
                ...
                If vector_nominal(i) <> 0 Then
                    ...
                    Else
                        ...
                        Dim umref_valcons As Double = coma(Math.Sqrt(cuadrado_patron(umref_const)))
                        Dim ui_valcons As Double = coma(Math.Sqrt(cuadrado_indicacion(umref_const)))
                        Dim esa As Double = coma(Math.Sqrt(cuadrado_indicacion(i - 1)))
                ...
                'tCell.InnerText = "coma((" & uer(i) & " * " & k(i) & "). " & uer(i) * k(i) & "" 'ToString("E1"))
                tRow.Cells.Add(tCell)
            ...
            While (ObjReader1.Read())
                ...
                End While
                ObjReader2.Close()
                'Dim incert As Double = Val(lblValExctMax2.Text) / (2 * Val(lblValCarga_exct2.Text) * Math.Sqrt(3))
                'excentricidad_total_2 = coma(incert)
                'lblIncertidumbreExct2.Text = coma(incert.ToString("0.000000"))
            End While
            ObjReader1.Close()
            Dim i_2 As Integer
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    Protected Sub btGenerar_Click(sender As Object, e As EventArgs) Handles btGenerar.Click
        ...
        Try
            ...
            Response.Redirect("PgHIII.aspx", False)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If TextBox1.Text = "" Then
            consulta = "select distinct(IdeBpr) from Balxpro where est_esc='PL' and (ClaBpr='III' or ClaBpr='IIII')"
        Else
            consulta = "SELECT DISTINCT(Balxpro.IdeBpr)
                            ...
                            WHERE (Clientes.NomCli like '" & TextBox1.Text & "%') 
		                         AND (Balxpro.est_esc = 'PL') 
		                         AND (Balxpro.ClaBpr='III' or Balxpro.ClaBpr='IIII')"
        End If
        Dim ObjCmd = New SqlCommand(consulta, ccn)
        Dim adaptador As SqlDataAdapter = New SqlDataAdapter(ObjCmd)
        Dim ds As DataSet = New DataSet()
