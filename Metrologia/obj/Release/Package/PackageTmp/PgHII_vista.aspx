<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="PgHII_vista.aspx.vb" Inherits="Metrologia.PgHII_vista" %>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td style="border-left: thin solid #0000FF; border-right: thin none #0000FF; border-top: thin solid #0000FF; border-bottom: thin none #0000FF;font-size: x-large; font-weight: bold; font-style: normal; color: #808000; vertical-align: middle; text-align: center; " colspan="2" rowspan="4">
                REVISIÓN SATISFACTORIAS 
                <img alt="IMPRESO" src="images/impreso.jpg" style="width: 376px; height: 204px" /></td>
            
        </tr>
        <tr>
            <td style="border: thin solid #008000; width: 11%;">
                <asp:Label ID="Label6" runat="server" Text="Seleccione el ID de proyecto:"></asp:Label>
            </td>
            <td style="border: thin solid #008000; width: 13%;">
...
&nbsp;[g]</td>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td colspan="2" style="width: 43px; height: 33px;">9.</td>
