<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="pgHcal_Cam.aspx.vb" Inherits="Metrologia.pgHcal_Cam" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
    <h3 class="text-center"> HOJA DE CÁLCULO PARA BALANZA CLASE CAMIONERA</h3>
