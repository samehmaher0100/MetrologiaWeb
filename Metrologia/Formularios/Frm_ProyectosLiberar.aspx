<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="Frm_ProyectosLiberar.aspx.vb" Inherits="Metrologia.Frm_ProyectosLiberar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class=" container">
        ...
        <asp:GridView ID="Gv_Proyectos" class="table table-striped table-bordered table-sm" AutoGenerateColumns="false" runat="server">
            ...
            <Columns>
                <asp:BoundField DataField="Codigo" HeaderText="Proyecto" />
                ...
                <asp:BoundField DataField="ClaBpr" HeaderText="Tipo" />
