...
Public Class PgImpresaHIII
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        btGenerar.OnClientClick = "return confirm('¿Está usted seguro de volver a Generar este certificado?');"
        ...
        objcon.conectar()
            ...
            Str = "select DesBpr,IdentBpr,MarBpr,ModBpr,SerBpr,CapMaxBpr,UbiBpr,CapUsoBpr," &
                                ...
                                "CapCalBpr " &
                                "from Balxpro where IdeComBpr='" & envia & "'"
            Str_a = "select estbpr from balxpro where IdeComBpr='" & envia & "'"
            IdeComBpr_G = envia
...
aqui:
                ...
                Else
                    ...
                    Label5.Text = error_a & " <= " & emp_recal & ") And (" & error_d & " <= " & emp_recal
                    satisface_crg = False
                End If
            ...
            For i = 0 To dimension - 1
                ...
                End If
                    ...
                    tCell = New HtmlTableCell
                    'variable udmp
                    Dim udmp_lectura As String = coma(Val(coma(vector_u_deriva_patron(i))).ToString("E2"))
            ...
            For i = 0 To dimension - 1
                ...
                End If
                tCell = New HtmlTableCell
                    tCell.InnerText = coma(Oeff.ToString("E1"))
                    tRow.Cells.Add(tCell)
                    'k
            ...
            If cta_obs > 0 Then
                ...
                ObjReader1.Close()
            End If
                txtObs7.Text = Mid(obser(0), 5)
                txtObs8.Text = Mid(obser(1), 5)
                txtObs9.Text = Mid(obser(2), 5)
                txtObs10.Text = Mid(obser(3), 5)
                txtObs11.Text = Mid(obser(4), 5)
                txtObs12.Text = Mid(obser(5), 5)
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    Protected Sub btObs_Click(sender As Object, e As EventArgs) Handles btObs.Click
        ...
        Try
            objcon.conectar()
            Dim Sql_d As String = "delete from Observaciones where IdeComBpr='" & lblidecombpr.Text & "'" ')"
            Dim ObjWriter_d = New SqlDataAdapter()
            ObjWriter_d.DeleteCommand = New SqlCommand(Sql_d, ccn)
            ObjWriter_d.DeleteCommand.ExecuteNonQuery()
    ...
    Protected Sub btGenerar_Click(sender As Object, e As EventArgs) Handles btGenerar.Click
        ...
        Try
            ...
            Response.Redirect("PgImpresaHIII.aspx", False)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
