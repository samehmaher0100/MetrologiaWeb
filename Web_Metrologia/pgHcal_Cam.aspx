<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="pgHcal_Cam.aspx.vb" Inherits="Web_Metrologia.pgHcal_Cam" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%">
        <tr>
            <td style="border: thin solid #008000; width: 11%; height: 28px;">
                Filtre por Cliente:</td>
            <td style="border: thin solid #008000; width: 13%; height: 28px;">
