...
Public Class pgHcal_IIIyIIII
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            objcon.conectar()
            Dim consulta As String = "select distinct(IdeBpr) from Balxpro where (est_esc='PR' or est_esc='CR') and (ClaBpr='III' or ClaBpr='IIII')"
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownList1.SelectedIndexChanged
        If DropDownList1.SelectedIndex > 0 Then
            ...
            Else
                ...
                Dim ObjCmd = New SqlCommand("select LitBpr from Balxpro where IdeBpr=" & DropDownList1.SelectedValue & " and (ClaBpr='III' or ClaBpr='IIII') and (est_esc='PR' or est_esc='CR')", ccn)
                Dim adaptador As SqlDataAdapter = New SqlDataAdapter(ObjCmd)
                Dim ds As DataSet = New DataSet()
                adaptador.Fill(ds)
...
aqui:
            ...
            Dim umbeii As Double = ((0.10000000000000001 * 1.2 / 8000) + Val(lblval_emppat_eii.Text) / (4 * Val(lblValCarga_exct2.Text))) * Val(lblValCarga_exct.Text) / Val(coma(raizdetreseii))
            ...
            Dim kveii As Double = 0.00000011899999999999999
            Dim kheii As Double = 0.000000020199999999999999
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    Protected Sub btGenerar_Click(sender As Object, e As EventArgs) Handles btGenerar.Click
        ...
        Try
            ...
            Response.Redirect("pgHcal_IIIyIIII.aspx", False)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If TextBox1.Text = "" Then
            consulta = "select distinct(IdeBpr) from Balxpro where (est_esc='PR' or est_esc='CR') and (ClaBpr='III' or ClaBpr='IIII')"
        Else
