<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="pgHcal_II.aspx.vb" Inherits="Web_Metrologia.pgHcal_II" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script src="scripts/jquery-1.4.1.min.js" type="text/javascript"></script>
    <script src="scripts/jquery.autocomplete.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(document).ready(function () {
        $("#<%=TextBox1.ClientID%>").autocomplete('Search_VB.ashx');
        });      
    </script>
    <table style="width: 100%">
        <tr>
            <td style="border: thin solid #008000; width: 11%;">
                Filtre por Cliente:</td>
            <td style="border: thin solid #008000; width: 13%;">
                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                <asp:Button ID="Button1" runat="server" Text="Filtrar" />
            </td>
            <td colspan="2" style="border: thin solid #008000; font-size: x-large; font-weight: bold; font-style: normal; color: #808000; vertical-align: middle; text-align: center;" rowspan="2">
                HOJA DE CÁLCULO PARA BALANZA CLASE II</td>
            <td style="border-left: thin solid #0000FF; border-right: thin none #0000FF; border-top: thin solid #0000FF; border-bottom: thin none #0000FF;font-size: x-large; font-weight: bold; font-style: normal; color: #808000; vertical-align: middle; text-align: center; " colspan="2" rowspan="4">
                REVISIÓN NO SATISFACTORIAS<img alt="revisa" src="images/revisa.jpg" style="width: 334px; height: 222px" /></td>
        </tr>
        <tr>
            <td style="border: thin solid #008000; width: 11%;">
                <asp:Label ID="Label1" runat="server" Text="Seleccione el ID de proyecto:"></asp:Label>
            </td>
            <td style="border: thin solid #008000; width: 13%;">
        ...
        <tr>
            <td style="border: thin solid #008000; width: 11%; " rowspan="2">
                <asp:Label ID="Label2" runat="server" Text="Seleccione el literal correspondiente:"></asp:Label>
            </td>
            <td colspan="2" rowspan="2" style="border: thin solid #008000; width: 229px;">
                <asp:DropDownList ID="DropDownList2" runat="server" Height="16px" Width="108px">
                </asp:DropDownList>
                <asp:Label ID="Label5" runat="server" Text="Label" Visible="False"></asp:Label>
            </td>
            <td style="border: thin solid #008000; width: 896px;">
                <asp:ImageButton ID="ImageButton1" runat="server" Height="77px" ImageUrl="/images/uploadfile.png" Width="92px" />
            </td>
        </tr>
        <tr>
            <td style="border: thin solid #008000; width: 896px;">
                <asp:Label ID="Label3" runat="server" Text="Cargar Información"></asp:Label>
            </td>
        </tr>
        <tr>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td style="border: thin solid #000080; width: 27%; height: 35px;">
            ...
            <td style="border: thin solid #000080; width: 9%; text-align: center; height: 35px;">
            ...
            <td style="border-left: thin none #800000; border-right: thin solid #800000; border-top: thin none #800000; border-bottom: thin none #800000; width: 6%; height: 35px;"></td>
            <td style="border: thin solid #800000; width: 211px; text-align: center; height: 35px;">
                <asp:Label ID="lbl_1e" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border: thin solid #800000; width: 16%; text-align: center; height: 35px;">
                <asp:Label ID="lbl_2e" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border: thin solid #800000; width: 17%; height: 35px;">
    ...
    <table id="tbExct" style="width:100%;">
        <tr>
            <td colspan="11" style="border: medium solid #000080; text-align:center;">PRUEBA DE EXCENTRICIDAD (Exc.)</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="border: thin ridge #0000FF; width: 7%; text-align: center;">
                <asp:Label ID="lblValPos1" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            ...
            <td style="border: thin ridge #0000FF; width: 9%; text-align: center;">
                <asp:Label ID="lblValPos4" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border: thin ridge #0000FF; width: 7%; text-align: center;">
                <asp:Label ID="lblValPos5" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td style="border: thin ridge #0000FF; width: 7%; text-align: center;">
                <asp:Label ID="lblDifPos1" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border: thin ridge #0000FF; width: 99px; text-align: center;">
                <asp:Label ID="lblDifPos2" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border: thin ridge #0000FF; width: 12%; text-align: center;">
                <asp:Label ID="lblDifPos3" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border: thin ridge #0000FF; width: 9%; text-align: center;">
                <asp:Label ID="lblDifPos4" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border: thin ridge #0000FF; width: 7%; text-align: center;">
                <asp:Label ID="lblDifPos5" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td colspan="4" style="border-style: solid; border-width: thin; border-color: #800000 #800000 #800000 #000080; text-align:center; font-weight: bold; color: #800000;">Verificación de resultados por recálculo</td>
        </tr>
        <tr>
    ...
    <table style="width:100%;">
        <tr>
            <td colspan="11" style="border: medium solid #000080; text-align: center; height: 30px;">PRUEBA DE REPETIBILIDAD</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align: center; border-style: solid solid solid solid; border-width: thin; border-color: #000080;">4</td>
            <td style="text-align: center; border-style: solid solid solid solid; border-width: thin; border-color: #000080;">5</td>
            <td style="text-align: center; border-style: solid solid solid solid; border-width: thin; border-color: #000080;">6</td>
        ...
        <tr>
            ...
            <td style="border-style: solid solid solid solid; border-width: thin; border-color: #000080; text-align: center;">
                <asp:Label ID="lblValRep4" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border-style: solid solid solid solid; border-width: thin; border-color: #000080; text-align: center;">
                <asp:Label ID="lblValRep5" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border-style: solid solid solid solid; border-width: thin; border-color: #000080; text-align: center;">
                <asp:Label ID="lblValRep6" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border-style: none solid none none; border-width: thin; border-color: #800000;">&nbsp;</td>
        ...
        <tr>
            ...
            <td style="border-style: solid solid solid solid; border-width: thin; border-color: #000080; text-align: center;">
                <asp:Label ID="lblValRep4_0" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border-style: solid solid solid solid; border-width: thin; border-color: #000080; text-align: center;">
                <asp:Label ID="lblValRep5_0" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border-style: solid solid solid solid; border-width: thin; border-color: #000080; text-align: center;">
                <asp:Label ID="lblValRep6_0" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
            </td>
            <td style="border-style: none solid none none; border-width: thin; border-color: #800000;">&nbsp;</td>
...
&nbsp;[g]</td>
    ...
    <table style="width:100%;">
        <tr>
            <td style="border-left: thin solid #000000; border-right: thin solid #000000; border-top: thin solid #000000; border-bottom: thin none #000000; color: #000000; text-align: right; height: 25px; vertical-align: middle; width: 154px;">REALIZADO POR:&nbsp;&nbsp;&nbsp; </td>
            <td rowspan="2" style="border: thin solid #000000; color: #000000; vertical-align: middle; width: 606px;">SISTEMA DE GESTIÓN DE METROLOGÍA</td>
        ...
        <tr>
            ...
            <td style="border: thin solid #000000; color: #000000; text-align: right; width: 129px;">Cargo:</td>
    ...
    <table style="width:100%;">
        <tr>
            <td style="width: 540px">
                <asp:Label ID="lblcmdbpr" runat="server" Text="Label"></asp:Label>
                <asp:Label ID="lbldivcal" runat="server" Text="lbldivcal"></asp:Label>
                <asp:Label ID="lblidecombpr" runat="server" Text="lblidecombpr"></asp:Label>
            </td>
            <td>
